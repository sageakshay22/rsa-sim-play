import { BookOpen, Target, FlaskConical, Play, Code, FileCheck } from "lucide-react";
...
const items = [
  ...
  { title: "Objectives", url: "/objectives", icon: Target },
  { title: "Theory", url: "/theory", icon: FlaskConical },
  { title: "Simulation", url: "/simulation", icon: Play },
  { title: "Code", url: "/code", icon: Code },
  { title: "Conclusion", url: "/conclusion", icon: FileCheck },
];
